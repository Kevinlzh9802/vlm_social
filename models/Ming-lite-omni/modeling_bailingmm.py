...
class BailingMMNativeForConditionalGeneration(PreTrainedModel):
    ...
    def __init__(
        ...
        if attn_implementation is not None:
            if self.config.vision_config is not None:
                self.config.vision_config._attn_implementation = attn_implementation
            if self.config.llm_config is not None:
                self.config.llm_config._attn_implementation = attn_implementation
        self.vision = None
        self.audio = None
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        load_image_gen_modules = kwargs.pop("load_image_gen_modules", True)
        model = super().from_pretrained(
            pretrained_model_name_or_path,
            *model_args,
            **kwargs,
        )
        if load_image_gen_modules:
