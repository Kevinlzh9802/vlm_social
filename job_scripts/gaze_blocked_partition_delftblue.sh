...
DEFAULT_FOCUS_PLOT_OUTPUT_DIR="/scratch/zli33/data/gestalt_bench/human_eval/task2/extraction_focus_from_partition"
DEFAULT_DEBUG_OVERLAY_OUTPUT_DIR="/scratch/zli33/data/gestalt_bench/human_eval/task2/gaze_overlay_debug"
