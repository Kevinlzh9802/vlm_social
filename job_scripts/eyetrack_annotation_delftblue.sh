...
DEFAULT_OUTPUT_DIR="${DATA_ROOT:-/path/to/data/gestalt_bench}/human_eval/task2/extraction_focus_new"
DEFAULT_LOCAL_PATH_PREFIX="${DATA_ROOT:-/path/to/data/gestalt_bench}/human_eval/videos"
